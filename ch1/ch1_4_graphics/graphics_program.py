...
def main():
    ...
    while command != "":
        ...
        if command == "goto":
            ...
            # to raise. The string will be printed when the exception is printed.
        ...
        # This code iterates through the commands to do the drawing and demonstrates
        # the use of the __iter(self)__ method in the PyList class above.
